-- Improve create_team_player RPC:
-- 1. Allow team creators and vice-captains as well as captains and match admins.
-- 2. Mark inline-added players as is_playing_xi = true by default.
...
BEGIN
  ...
  -- Team creator, captain, or vice-captain
  SELECT EXISTS (
