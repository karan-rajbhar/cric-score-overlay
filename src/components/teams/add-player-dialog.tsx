                        ...
                        {users.length > 0 ? (
                            users.map((user) => (
                                <div
                                    key={user.id}
                                    className={cn(
                                        "flex items-center justify-between p-3 rounded-md border cursor-pointer hover:bg-muted transition-colors",
                                        selectedUser === user.id && "border-primary bg-primary/5 ring-1 ring-primary"
                                    )}
