...
export function MatchPartnerships({ match }: { match: Match }) {
    const [inningsGroups, setInningsGroups] = useState<
        Array<{ inningsId: string; teamName: string; rows: Partnership[] }> | null
    >(null);
        ...
        <Card>
            ...
            <CardContent>
                {inningsGroups === null ? (
                    ...
                    <p className="text-sm text-muted-foreground">No partnerships recorded yet.</p>
                ) : (
