...
export const PALETTE = {
  ...
  // Multi-Elevation Neutral Surfaces (Dark Mode - Floodlit Stadium Palette)
  darkSurfaces: {
    base: {
      hsl: "160 14% 6%",
      hex: "#0d1210",
      rgb: [13, 18, 16],
      label: "Surface Base (Dark Stadium Obsidian)",
    },
    surface1: {
      hsl: "160 10% 9%",
      hex: "#141a17",
      rgb: [20, 26, 23],
      label: "Surface 1 (Card/Sidebar Stadium Charcoal)",
    },
    surface2: {
      hsl: "160 10% 12%",
      hex: "#1b231f",
