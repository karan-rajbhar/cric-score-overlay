...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 pb-16">
      {/* Sunlit Hero Section */}
      <section className="relative overflow-hidden rounded-3xl border border-emerald-500/20 bg-gradient-to-b from-card via-card/90 to-emerald-500/5 px-6 py-16 text-center shadow-sm sm:px-12 sm:py-24">
        ...
        <div className="relative mx-auto max-w-4xl">
          <h1 className="text-balance text-4xl font-black tracking-tight text-foreground sm:text-6xl sm:leading-[1.15]">
            ...
            {user ? (
              <>
                <Button
                  asChild
                  size="lg"
                  className="interactive-button h-11 rounded-xl bg-primary px-7 font-bold shadow-md hover:bg-primary/90"
                >
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="interactive-button h-11 rounded-xl border-border/80 px-7 font-semibold"
                >
      ...
      <section className="rounded-3xl border border-border/80 bg-card p-6 sm:p-10">
        ...
        <div className="mt-8 grid gap-8 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-6">
            <h3 className="flex items-center gap-2 font-bold text-emerald-950 dark:text-emerald-200">
          ...
          <div className="rounded-2xl border border-sky-500/20 bg-sky-500/5 p-6">
            <h3 className="flex items-center gap-2 font-bold text-sky-950 dark:text-sky-200">
        ...
        <div className="mt-8 flex items-center justify-center">
          <Button
            asChild
            size="lg"
            className="interactive-button rounded-xl bg-primary px-8 font-bold"
          >
