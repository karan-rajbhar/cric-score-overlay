                ...
                <p className="leading-relaxed text-muted-foreground">
                  {signupMethod === "email" ? (
                    <>
                      ...
                      <strong className="text-cricket-secondary">
                        {email}
                      </strong>
    ...
    <div className="flex min-h-screen items-center justify-center px-3 py-8 sm:px-6 sm:py-12 lg:px-8">
      <div className="w-full max-w-md space-y-6 sm:space-y-8">
        ...
        <div className="space-y-2 text-center">
          <h1 className="text-2xl font-bold tracking-tight">Join CricScore</h1>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {passwordRequirements.map((req, index) => (
                          <div key={index} className="flex items-center gap-1">
                            <div
                              className={`h-2 w-2 rounded-full ${req.met ? "bg-cricket-secondary" : "bg-muted-foreground/30"}`}
                            ></div>
                            <span
                              className={`text-xs ${req.met ? "text-cricket-secondary" : "text-muted-foreground"}`}
                            >
                              {req.text}
                            </span>
                          </div>
